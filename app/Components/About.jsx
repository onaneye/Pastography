...
const About = () => {
  ...
  return (
    <div className="max-w-">
    <div className='lg:flex flex-1 flex-col container mx-auto p-2 items-center justify-between mt-[10%]'>
